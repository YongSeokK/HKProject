from config import DB_USERNAME, DB_PASSWORD, DB_HOST, DB_NAME, Root_Path, Region_Dict, Whole_List, Daily_FolderPath
...
DailyDB = DailyDB(DB_USERNAME, DB_HOST, DB_PASSWORD, DB_NAME, Region_Dict, Whole_List, Daily_FolderPath)
