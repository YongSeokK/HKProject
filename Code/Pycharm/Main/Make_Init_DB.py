...
from config import DB_USERNAME, DB_PASSWORD, DB_HOST, DB_NAME, Area_Dict, \
    Retail_FolderPath, RecipeData_FilePath, WholesaleVolume_FilePath, WholesalePrice_FilePath
